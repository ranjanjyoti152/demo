...
rendezvous_server = '182.77.48.166'
nat_type = 1
serial = 3

[options]
rendezvous-servers = 'rs-ny.rustdesk.com,rs-sg.rustdesk.com,rs-cn.rustdesk.com'
key = '0B0HzkWOGUI13neJNw+fYJWtbSQaZo6aRHY9tQtuDGo='
custom-rendezvous-server = '182.77.48.166'
api-server = 'https://182.77.48.166'
relay-server = '182.77.48.166'
EOF
)"
